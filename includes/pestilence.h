...
# define PATTERN_ENTRY_OLD		0xe9
# define PATTERN_ENTRY_OLD_SIZE_OPCODE	1

# define PATTERN_KEY_SIZE		0xbe48
# define PATTERN_KEY_SIZE_OPCODE	2

# define PATTERN_TEXT_SIZE		0xb948
# define PATTERN_TEXT_SIZE_OPCODE	2
